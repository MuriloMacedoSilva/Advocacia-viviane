...
// function Inicio() {
//     return (
//         <section id="Inicio" className="bg-transparent md:py-[350px] xl:h-[100vh] scroll-smooth md:mt-0 left-0 w-screen flex flex-col pb-[100px] px-[20px] md:flex-row md:justify-center md:gap-10 md:items-center">
