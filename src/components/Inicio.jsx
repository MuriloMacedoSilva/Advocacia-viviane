    ...
    return (
        <section id="Inicio" className="bg-transparent md:h-[120vh] h-[160vh] mt-[100px] md:mt-0 left-0 w-screen flex flex-col pb-[30px] px-[20px] md:flex-row md:justify-center md:gap-15 md:items-center">
            ...
            <div className=" max-w-[550px] gap-16 max-h-[500px]">
                <h2 className="bg-gradient-to-r from-amber-200 to-orange-400 bg-clip-text text-transparent text-[20px] tracking-[15px] font-Inter font-semibold lg:text-[35px] text-shadow-lg">ADVOCACIA</h2>
                ...
                <div className="md:flex md:justify-between mt-[50px] gap-7 w-full">
                    <a href="https://www.instagram.com/dra.v_luizmacedoadvogada/" target="_blank" className="w-full md:w-[50%] mt-[30px] bg-lime-300 flex items-center justify-center h-[60px] text-[15px] text-amber-950 font-light hover:bg-lime-300/60 hover:border hover:border-lime-300 transition duration-200">
