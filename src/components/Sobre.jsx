...
function Sobre() {
    return (
          <section className="flex flex-col lg:flex-row justify-end items-center bg-gradient-to-b from-mar/90 to-50% to-black pt-[70px] backdrop-blur-sm pb-[50px] px-1.5">
