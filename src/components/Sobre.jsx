...
function Sobre() {
    return (
          <section className="flex flex-col lg:flex-row justify-end items-center bg-gradient-to-b md:from-black/80 to-50% md:to-black/80 from-black/90 to-black pt-[70px]  pb-[50px] px-1.5">
